...
Note that I have focused on making the code simple, easily
...
class Network(object):
    ...
    def __init__(self, sizes):
        ...
        in the respective layers of the network. For example,
        if the list was [2, 3, 1] then it would be a three-layer
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        for x, y in mini_batch:
            ...
            print "type(delta_nabla_w)", type(delta_nabla_w)
            print "type(delta_nabla_w[0])", type(delta_nabla_w[0])
            print "delta_nabla_w[0].shape[0]:", delta_nabla_w[0].shape[0]
            print "delta_nabla_w[0].shape[1]:", delta_nabla_w[0].shape[1]
            #print delta_nabla_w[0]
            print "nabla_w[0].shape:", nabla_w[0].shape
    ...
    def backprop(self, x, y):
        ...
        # It's a renumbering of the scheme in the book, used here to
        # take advantage of the fact that Python can use negative
        # indices in lists.
    ...
    def evaluate(self, test_data):
        ...
        network outputs the correct result. Note that neural
